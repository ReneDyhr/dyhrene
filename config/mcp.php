...
return [
    ...
    'redirect_domains' => \env('MCP_OAUTH_REDIRECT_DOMAINS')
        ? \array_values(\array_filter(\array_map('trim', \explode(',', (string) \env('MCP_OAUTH_REDIRECT_DOMAINS')))))
        : [
            '*',
            // Tighten for production: set MCP_OAUTH_REDIRECT_DOMAINS=https://claude.ai,https://www.anthropic.com
        ],
