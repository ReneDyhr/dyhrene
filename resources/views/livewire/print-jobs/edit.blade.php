                        ...
                        <form wire:submit.prevent="save" x-data="{ 
                            ...
                            <div class="form-group" style="margin-bottom: 15px;" x-data="{
                                ...
                                <div style="position: relative;">
                                    <input type="text" :value="inputValue" @focus="handleFocus()" @click="handleFocus()"
                                        @input="handleInput($event)" @blur="handleBlur()"
                            ...
                            <div class="form-group" style="margin-bottom: 15px;">
                                ...
                                <input type="number" id="pieces_per_plate"
                                    wire:model.live.debounce.500ms="pieces_per_plate" class="form-control" min="1"
                                    max="100">
                            ...
                            <div class="form-group" style="margin-bottom: 15px;">
                                ...
                                <input type="number" id="plates" wire:model.live.debounce.500ms="plates"
                            ...
                            <div class="form-group" style="margin-bottom: 15px;">
                                ...
                                <input type="number" id="grams_per_plate"
                                    wire:model.live.debounce.500ms="grams_per_plate" class="form-control" step="0.01"
                                    min="0" max="999" placeholder="0.00" inputmode="decimal">
                            ...
                            <div class="form-group" style="margin-bottom: 15px;">
                                ...
                                <div style="display: flex; gap: 10px; align-items: center;">
                                    <div style="flex: 1;">
                                        <label for="hours_per_plate_hours"
                                            style="font-size: 0.9em; color: #666; display: block; margin-bottom: 4px;">Hours</label>
                                        <input type="number" id="hours_per_plate_hours"
                                            wire:model.live.debounce.500ms="hours_per_plate_hours" class="form-control"
                                    ...
                                    <div style="flex: 1;">
                                        <label for="hours_per_plate_minutes"
                                            style="font-size: 0.9em; color: #666; display: block; margin-bottom: 4px;">Minutes</label>
                                        <input type="number" id="hours_per_plate_minutes"
                                            wire:model.live.debounce.500ms="hours_per_plate_minutes"
                            ...
                            <div class="form-group" style="margin-bottom: 15px;">
                                ...
                                <input type="number" id="avance_pct_override"
                                    wire:model.live.debounce.500ms="avance_pct_override" class="form-control"
                        ...
                        <div class="calculation-panel"
                            ...
                            <div
                                ...
                                <h2 style="margin: 0; font-size: 1.3em;">
                                    ...
                                    @if($isLocked)
                                        <span class="badge"
                                            style="background-color: #28a745; color: #fff; padding: 4px 12px; border-radius: 4px; font-size: 0.7em; margin-left: 10px;">
