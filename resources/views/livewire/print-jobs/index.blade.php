                                    ...
                                    @forelse($printJobs as $job)
                                        <tr>
                                            ...
                                            <td style="padding: 8px;">
                                                @if($job->status === 'draft')
                                                    <span class="badge"
                                                        style="background-color: #ffc107; color: #000; padding: 4px 8px; border-radius: 4px;">Draft</span>
                                                @else
                                                    <span class="badge"
                                                        style="background-color: #28a745; color: #fff; padding: 4px 8px; border-radius: 4px;">Locked</span>
                                                @endif
                                            </td>
                                            <td style="padding: 8px; text-align: right;">
                                                {{ \App\Support\Format::integer($job->calculation['totals']['total_pieces'] ?? 0) }}
                                            </td>
                                            <td style="padding: 8px; text-align: right;">
                                                {{ \App\Support\Format::dkk($job->calculation['costs']['total_cost'] ?? 0) }}
                                            </td>
                                            <td style="padding: 8px; text-align: right;">
                                                {{ \App\Support\Format::dkk($job->calculation['pricing']['sales_price'] ?? 0) }}
                                            </td>
                                            <td style="padding: 8px; text-align: right;">
                                            ...
                                            <td style="padding: 8px;">
                                                ...
                                                @if($job->isDraft())
                                                    <a href="{{ route('print-jobs.edit', $job) }}"
