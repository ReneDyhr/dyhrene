<div>
    ...
    <div id="main">@include('components.layouts.header')<div class="content homepage"><div class="col-12"><div class="storage-list"><div class="recipe">
        ...
        <div id="wild-edible-detail-map" data-markers='@json($markers)' data-center-lat="{{ $wildEdible->latitude }}" data-center-lng="{{ $wildEdible->longitude }}" data-map-id="{{ config('wild-edibles.google_maps_map_id') }}" class="wild-edible-map"></div>
