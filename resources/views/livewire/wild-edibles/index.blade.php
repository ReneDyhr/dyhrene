<div>
    ...
    <div id="main">@include('components.layouts.header')<div class="content homepage"><div class="col-12"><div class="storage-list"><div class="recipe">
        ...
        <div id="wild-edibles-map" data-markers='@json($markers)' data-center-lat="{{ config('wild-edibles.default_center.latitude') }}" data-center-lng="{{ config('wild-edibles.default_center.longitude') }}" data-map-id="{{ config('wild-edibles.google_maps_map_id') }}" class="wild-edible-map"></div>
